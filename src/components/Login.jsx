...
const Login = () => {
    ...
    const handleSubmit = () => {
        console.log(checkValidation(email.current.value, password.current.value));
    }
            ...
            <div className="m-4 p-2 absolute w-62 z-20">
             ...
             <div className="absolute inset-0 z-10 flex items-center justify-center">
                <form className="m-4 py-4 w-3/12 h-120 text-white flex flex-col items-center bg-black/80 rounded-2xl"  onSubmit={(e) => e.preventDefault()}>
                    ...
                    {!isSignIn && <input className="w-8/12 mt-4 mx-4 p-2 bg-gray-800 rounded-lg" type="textbox" placeholder="Full Name"></input>}
