...
const MovieDetail = () => {
    ...
    return (<div className="w-full h-full relative">
        <div className="absolute inset-0 aspect-video z-0"><VideoTrailer movieId={mainMovie.id} /></div>
        <div className="absolute inset-0 z-10 bg-linear-to-r from-black/90 via-black/40"></div>
        <div className="absolute inset-0 left-10 top-90 w-1/3 z-20 text-white text-shadow">
            <h1 className="m-4 p-4 font-bold text-4xl">{mainMovie.original_title}</h1>
            <p className="m-4 px-4">{mainMovie.overview}</p>
            <div className="m-4 p-4 z-20">
